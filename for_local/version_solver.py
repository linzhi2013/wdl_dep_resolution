...
def read_all_package_info(wdl_package_info_file=None):
    all_pkg_deps = []
...
def pkg_verison_solver(wdl_package_info=None, query_pkg_version=None):
    '''
    wdl_package_info content format:
        hello   1.0 python:=3.7, perl:<6 >5, c:<2
        c 1.2 python
    ...
    all_pkg_deps = read_all_package_info(wdl_package_info)
    query_pkgs = []
...
if __name__ == '__main__':
    result = pkg_verison_solver(
        wdl_package_info='wdl_package_info.txt',
